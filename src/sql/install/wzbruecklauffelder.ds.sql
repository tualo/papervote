...
INSERT IGNORE INTO `ds_column` (`table_name`, `column_name`, `default_value`, `default_max_value`, `default_min_value`, `is_primary`, `update_value`, `is_nullable`, `is_referenced`, `referenced_table`, `referenced_column_name`, `data_type`, `column_key`, `column_type`, `character_maximum_length`, `numeric_precision`, `numeric_scale`, `character_set_name`, `privileges`, `existsreal`, `deferedload`, `writeable`, `note`, `hint`) VALUES ('wzbruecklauffelder','aktiv','1',0,0,0,'','YES','NO','','','tinyint','','tinyint(4)',NULL,3,0,NULL,'select,insert,update,references',1,0,1,'',''),
('wzbruecklauffelder','column_name','',0,0,1,'','NO','NO','','','varchar','PRI','varchar(50)',50,NULL,NULL,'utf8mb3','select,insert,update,references',1,0,1,'',''),
('wzbruecklauffelder','reihenfolge','0',0,0,0,'','YES','NO','','' ,'int','','int(11)',NULL,10,0,NULL,'select,insert,update,references',1,0,1,'','');
UNLOCK TABLES;

LOCK TABLES `ds_column_list_label` WRITE;
INSERT IGNORE INTO `ds_column_list_label` (`table_name`, `column_name`, `language`, `label`, `xtype`, `editor`, `position`, `summaryrenderer`, `summarytype`, `hidden`, `active`, `renderer`, `filterstore`, `flex`, `direction`, `align`, `grouped`, `listfiltertype`, `hint`) VALUES ('wzbruecklauffelder','aktiv','DE','Aktiv','gridcolumn','',2,'','',0,1,'','',1.00,'ASC','left',0,'',''),
('wzbruecklauffelder','column_name','DE','Name','gridcolumn','',3,'','',0,1,'','',1.00,'ASC','left',0,'',''),
('wzbruecklauffelder','reihenfolge','DE','Reihenfolge','numbercolumn','',1,'','',0,1,'','',1.00,'ASC','left',0,'','');
UNLOCK TABLES;

LOCK TABLES `ds_column_form_label` WRITE;
INSERT IGNORE INTO `ds_column_form_label` (`table_name`, `column_name`, `language`, `label`, `xtype`, `field_path`, `position`, `hidden`, `active`, `allowempty`, `fieldgroup`) VALUES ('wzbruecklauffelder','aktiv','DE','Aktiv','checkbox','Allgemein',1,0,1,1,''),
('wzbruecklauffelder','column_name','DE','Name','combobox_view_wzbruecklauffelder_columns_column_name','Allgemein',2,0,1,1,'');
UNLOCK TABLES;
...
INSERT IGNORE INTO `ds_access` (`role`, `table_name`, `read`, `write`, `delete`, `append`, `existsreal`) VALUES ('administration','wzbruecklauffelder',0,1,1,1,1);
UNLOCK TABLES;
