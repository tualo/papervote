...
('wahlzeichnungsberechtigter','insert_date','null',0,0,'',0,0,NULL,NULL,'YES','NO',1,'','date','','date',NULL,NULL,NULL,NULL,'select,insert,update,references',1,0,'',''),
('wahlzeichnungsberechtigter','insert_time','null',0,0,'null',0,0,NULL,NULL,'YES','NO',1,'','time','','time',NULL,NULL,NULL,NULL,'select,insert,update,references',1,0,'',''),
('wahlzeichnungsberechtigter','kostenstelle','{:getZero()}',0,0,'',1,0,'','','NO','NO',1,'\'\'','int','PRI','int(11)',NULL,10,0,NULL,'select,insert,update,references',1,0,'',''),
('wahlzeichnungsberechtigter','login','null',0,0,'null',0,0,NULL,NULL,'YES','NO',1,'','varchar','','varchar(255)',255,NULL,NULL,'utf8mb4','select,insert,update,references',1,0,'',''),
...
('wahlzeichnungsberechtigter','ridx','null',0,0,'',0,0,NULL,NULL,'YES','NO',1,'','varchar','','varchar(255)',255,NULL,NULL,'utf8mb4','select,insert,update,references',1,0,'',''),
('wahlzeichnungsberechtigter','update_date','null',0,0,'null',0,0,NULL,NULL,'YES','NO',1,'','date','','date',NULL,NULL,NULL,NULL,'select,insert,update,references',1,0,'',''),
('wahlzeichnungsberechtigter','update_time','null',0,0,'null',0,0,NULL,NULL,'YES','NO',1,'','time','','time',NULL,NULL,NULL,NULL,'select,insert,update,references',1,0,'',''),
...
UNLOCK TABLES;
LOCK TABLES `ds_access` WRITE;
INSERT IGNORE INTO `ds_access` (`role`, `table_name`, `read`, `write`, `delete`, `append`, `existsreal`) VALUES ('administration','wm_tannummer',1,1,1,1,0);
UNLOCK TABLES;
