...
VALUES ('view_stimmenanzahl_ranking_los_monitor','Ranking-Stimmenverteilung-Monitor','',0,'anzeige_name','anzeige_name','anzeige_name',1,'','','','',0,'tualomultirowmodel','',0,'','',1,'Wahlsystem','','','listview','XlsxWriter','{GUID}',0,0,'','',100,'Tualo.DataSets.ListView',1)
