    ...
    and table_name in (
        select table_name from (
            ...
            from
                `ds_column`
            where
                `table_name` = 'view_wm_wahlbeteiligungwahl_beteiligung_bericht_formel_object'
        ) as s where s.s = 0
);
