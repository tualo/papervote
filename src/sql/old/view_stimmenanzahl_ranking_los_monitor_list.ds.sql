...
`table_name`='view_stimmenanzahl_ranking_los_monitor_list' and `column_name`='id'
and (select sum(`is_primary`) from `ds_column` where `table_name`='view_stimmenanzahl_ranking_los_monitor_list')=0;
