Ext.define('Tualo.PaperVote.lazy.monitor.SZGViewport', {
    extend: 'Ext.panel.Panel',
    requires: [
        'Tualo.PaperVote.lazy.monitor.models.Viewport',
        'Tualo.PaperVote.lazy.monitor.controller.SZGViewport'
    ],
    alias: 'widget.cmp_wm_wahlausschuss_mon_szg',
    controller: 'cmp_wm_wahlausschuss_mon_szg',
    viewModel: {
