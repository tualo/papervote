Ext.define('Tualo.PaperVote.lazy.pagination.Viewport', {
  ...
  initComponent: function () {
    ...
    this.items = [
      Ext.create('Ext.grid.Panel', {
        tbar: [{
          text: 'Paginierung abbrechen',
          scope: this,
          handler: function () {
            Ext.MessageBox.prompt('Paginierung entwerten', 'Bitte geben Sie die Paginierungsnummer ein:', function (btn, text) {
              if (btn == 'ok') {
                Ext.MessageBox.wait("Bitte Warten...");
                Ext.Ajax.request({
                  url: "./papervote/pagination/cancle/" + text,
